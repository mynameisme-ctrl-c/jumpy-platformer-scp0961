...
hero = sprites.create(img`
    ...
    . f d e e d d d d d d d d d f . 
    . f d e d d f d d d d f d d f . 
    . f e d d d f d d d 6 6 6 6 6 6 
    . . f d d d f d 6 6 6 6 6 6 6 . 
    . . f d d d 6 6 6 6 6 6 d d f . 
    . . f b 6 6 6 6 6 c c c c a f . 
    . . 6 6 6 6 c c c c c c d d f . 
    . 6 6 6 d f f f b b f f f d f . 
    6 6 f b a a a a a a a a a f . . 
    . . . f b a a f f b a a f . . . 
    . . . f b a a f f b a a f . . . 
    . . . . f f f . . f f f . . . . 
    `, SpriteKind.Player)
